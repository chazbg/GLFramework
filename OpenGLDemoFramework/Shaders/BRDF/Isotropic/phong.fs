...
void main()
{
    ...
    specularContribution += specular * (m + 2) * pow(RoL0, m) * light0.iL;
    specularContribution += specular * (m + 2) * pow(RoL1, m) * light1.iL;
    specularContribution += specular * (m + 2) * pow(RoL2, m) * light2.iL;
